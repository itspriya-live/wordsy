...
## Note on the restart
Full restart at user's request on 2026-08-29. Progress reset to 0; learning begins fresh from
Theme 1, word #1. Now covers 743 words (63 new words added 2026-08-29). Inflected forms folded
into their headword and not counted separately.

## Spaced-review schedule
Re-test at +1, +3, +7, +16 days, then retire to "solid".

## Learning log
| Date | Day | Words taught | New | Cumulative | Reviewed |
|------|-----|--------------|-----|------------|----------|
| 2026-08-29 | 1 | Competence, Crank out, Emulate | 3 | 3 | — |
| 2026-08-30 | — | (review + self-check) | 0 | 3 | Competence, Crank out, Emulate |
| 2026-08-31 | 2 | Exert, Expend, Menial (Emulated/Exertion folded) | 3 | 6 | — |
...
- [x] Crank out
- [x] Emulate
- [x] Emulated (form of Emulate)
- [x] Exert
- [x] Exertion (form of Exert)
- [x] Expend
- [x] Menial
- [x] Outclass
- [x] Personnel policy
...
- Expend : 2026-09-11 (+7)
- Menial : 2026-09-11 (+7)
- Outclass : 2026-09-06 (+3)
- Personnel policy : 2026-09-06 (+3)
- Pinnacle : 2026-09-06 (+3)
- Prevail : 2026-09-07 (+3)
- Prowess : 2026-09-07 (+3)
- Zeal : 2026-09-07 (+3)
